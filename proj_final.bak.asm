...
PASSENGER_FREQ	EQU	1	;; Frequencia com que sao colocados novos passageiros
...
NEW_GAME_KEY	EQU	'n'	;; Letra para Iniciar novo jogo
NUM_ENDGAME_STR	EQU	3	;; Numero de linhas da String de fim de jogo
END_GAME_POS	EQU	0041h	;; Posicao onde escrever String de fim de jogo (L0, C65)

;; Ponteiro da Janela de Texto
NEXT_LINE	EQU	0100h	;; Valor a somar para incrementar a linha na Janela Texto
...
;;
;; Entrad: M[RandNum] - Sequencia Antiga
...
MidGame:	CMP	M[Test_Temp], R0
		...
		CALL	RefreshScore	; Aumentar Pontuacao
...
;; pontuacao e escreve a nova pontuacao no Display de 7 Segmentos
;;
;; Entrad: nenhuma
;; Saidas: nenhuma
...
;; insere o passageiro na String e na Janela de Texto
;;
;; Entrad: nenhuma
;; Saidas: nenhuma
